...
<head>
    ...
    <script type="text/javascript">
        ...
        function address() {
            ...
            val1 = $("#phone").val();
            if ($("#sname").val() == "" || $("#phone").val() == "" || $("#xxdz").val() == "" || $("#s_province").val() == "--请选择--" || $("#s_city").val() == "--请选择--" || $("#s_county").val() == "--请选择--") {
                $("#div3").show();
                $("#span2").text("请完善地址信息！")
                setTimeout(function () {
                    $("#div3").hide();
...
<div class="container-fluid dd">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="info">
                        <div>
                            <input class="dz2" id="sname" type="text" placeholder="收货人姓名">
                            <input class="dz2" id="phone" type="text" placeholder="手机号">
                            <div class="d10" id="div2"><span class="sp14" id="span1"></span></div>
                            ...
                            <textarea class="dz3" id="xxdz" rows="3" cols="73" placeholder="详细地址"></textarea>
                        </div>
                        <div id="show"></div>
                    </div>
    ...
    <div class="d2 row">
        <div class="d2-1 row">
            ...
            <div class="d2-1-2 row">
                <span class="sp3-1">配送方式</span>
                <span class="sp4">包邮</span>
            </div>
            <div class="d2-1-2 row">
                <span class="sp3-2 col-lg-1 col-md-1">配送时间</span>
                <span class="sp5">
						<button class="bu3 col-lg-3 col-md-3">
							<span class="sp6">不限送货时间:</span> 周一至周日
						</button>
					</span>
                <span class="sp5">
						<button class="bu3 col-lg-3 col-md-2">
							<span class="sp6">工作日送货:</span> 周一至周五
						</button>
					</span>
                <span class="sp5">
						<button class="bu3 col-lg-3 col-md-2">
							<span class="sp6">双休日、假日送货:</span> 周六至周日
						</button>
					</span>
            </div>
            <div class="d2-1-2 row">
                <span class="sp3-2">发票</span>
                <span class="sp4">
						电子发票&nbsp;&nbsp;
						个人&nbsp;&nbsp;
						商品明细&nbsp;&nbsp;
