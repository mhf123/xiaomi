    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 0) {
                        var str = " " + data.data.list[0].receiverProvince + " " + data.data.list[0].receiverCity + " " + data.data.list[0].receiverDistrict;
                        $("#addr").text(str);
                    } else {
                        if (data.status == 2){
                            var str = " 北京 北京市 海淀区 ";
...
<div class="container-fluid">
    ...
    <div class="row d4">
        ...
        <div class="col-lg-6 col-md-6 d4-2">
            ...
            <div class="d4-2-2">
                &nbsp; <span class="glyphicon glyphicon-map-marker" id="addr"> 
                       </span>
                <a class="a5" data-toggle="modal" data-target="#myModal">&emsp;修改</a>
                <br/>
                <a class="a7" id="a7" href="">有现货</a>
                <span id="kc"></span>
            </div>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="d11" id="div33"><span class="sp14" id="span22"></span></div>
                ...
                <div class="modal-body">
                    <div class="info">
                        <div>
                            <select class="dz1" id="s_province" name="s_province"></select>  
                            <select class="dz1" id="s_city" name="s_city"></select>  
                            <select class="dz1" id="s_county" name="s_county"></select>
                        </div>
                        <div id="show"></div>
                    </div>
                </div>
                <div class="modal-footer d9">
                    ...
                    <button type="button" class="bu6" onclick="address()">修改</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function address() {
        ...
        val1 = $("#phone").val();
        if ($("#s_province").val() == "--请选择--" || $("#s_city").val() == "--请选择--" || $("#s_county").val() == "--请选择--") {
            $("#div33").show();
            $("#span22").text("请选择地址信息！");
            setTimeout(function () {
                $("#div33").hide();
            ...
            //显示地址
            var str = " " + receiverProvince + " " + receiverCity + " " + receiverDistrict;
            $("#addr").text(str);
